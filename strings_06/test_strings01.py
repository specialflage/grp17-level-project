...
emp_email = "yahia.momtaz.hussein@gmail.com"
#user_name = emp_email[0:12]
...
print(real_name, domain_name, real_name)

print("-------------Loop : loop over letters of string-------------")
...
print("---------strip(), title(), swapcase(), find(), rfind()----------")